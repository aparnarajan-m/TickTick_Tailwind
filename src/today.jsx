  ...
  return (
    <div className='w-[46%] border-r-2'>
            ...
            <div className='flex mt-6'>
                <div className='flex w-[100px] h-[30px] justify-around items-center ml-4'><img className='w-[22px] h-[22px]' src={menus} alt="" /><h1 className='text-[20px] font-bold'>Today</h1></div>
            ...
            <div className='flex  flex-col justify-center items-center mt-60'>
                ...
                <h1 className='mt-9 font-bold'>No tasks today</h1>
                <p className='text-[rgb(177,147,147)] text-[13px]'>Relax with a cup of tea</p>
            </div>
        </div>
  )
}
